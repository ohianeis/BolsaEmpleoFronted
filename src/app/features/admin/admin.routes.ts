...
export const ADMIN_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'usuarios',
        loadComponent: () =>
          import('./pages/gestionUsuarios/usuarios/usuarios').then((c) => c.Usuarios),
      },
      {
        path: 'configuracion',
      ...
      },
      {
        path: 'validaciones',
        loadComponent: () =>
          import('./pages/gestionValidaciones/validaciones/validaciones').then(
            (c) => c.Validaciones,
          ),
      },
      {
        path: 'staff',
        loadComponent: () =>
          import('./pages/gestionAdministradores/administradores/administradores').then(
            (c) => c.Administradores,
          ),
